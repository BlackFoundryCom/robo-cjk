...
# def computeCharacterGlyphPreview(glyph, position:dict, font = None):
#     locations = [{}]
...
#         g = computeDeepComponentPreview(font[name], position, font)
#         g = _transformGlyph(g, dc.get("transform"))
...
#         name = dc.get("name")
#         position = dc.get("coord")
#         g = computeAtomicElementPreview(font[name], position, font)
#         g = _transformGlyph(g, dc.get("transform"))
#         g.draw(resultGlyph.getPen())
...
#     # def __init__(self, axisGlyphPreview:list = [], **kwargs):
